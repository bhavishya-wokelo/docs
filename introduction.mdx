...
<Columns cols={2}>
  ...
  <Card title="M&A Activity" icon="user-magnifying-glass" href="/competitor-list-doc">
    Obtain in-depth acquisition activities of a given company.
  </Card>

  <Card title="Fundraising Activity" icon="user-magnifying-glass" href="/competitor-list-doc">
