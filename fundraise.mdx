...
<ParamField body="payload.topic" type="string" required>
  Company name to generate the fundraise report for
</ParamField>
...
public class FundraiseWorkflow {
  public static void main(String[] args) throws Exception {
    String body = "{\"reportType\":\"fundraisers_workflow\",\"payload\":{\"topic\":\"Apple\",\"workbook_name\":\"Apple\",\"advanced_settings\":{\"company_type\":\"all\",\"geography\":[\"Worldwide\"],\"funding_stage\":[],\"employee_count\":[],\"total_funding_include_blanks\":true}},\"reportSource\":\"WKLAPP\"}";
