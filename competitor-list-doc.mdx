...
### Exporting the peer set to CSV

Retrieve results and export the ranked peer set to CSV for valuation work, board decks, or CRM upload.
...
with open("peer_set.csv", "w", newline="") as f:
    fields = [
        "Name", "Permalink", "Website", "HQ City", "HQ Country",
        "Founded", "Type", "Operating Status", "Product Category",
        "Employees (Crunchbase)", "Funding Stage", "Total Funding",
        "Revenue", "EBITDA", "Market Cap", "EV/Revenue (LTM)", "EV/EBITDA (LTM)",
        "Acquisitions", "Overall Score", "Commentary"
    ]
    writer = csv.DictWriter(f, fieldnames=fields, extrasaction="ignore")
    writer.writeheader()
    writer.writerows(peers)

print(f"Exported {len(peers)} peers to peer_set.csv")
```
