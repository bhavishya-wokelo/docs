...
<ParamField body="sections" type="string[]" required>
  ...
  Supported values: `firmographics`, `products`, `headcount`, `funding`, `public_company_financials`, `uk_private_company_financials`, `uk_private_company_ownership`,`social_media`, `acquisitions`, `investments`, `website_traffic`
</ParamField>
