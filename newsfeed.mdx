...
fetch("https://api.wokelo.ai/api/enterprise/newsfeed/news/", requestOptions)
...
func main() {
  ...
  req, _ := http.NewRequest("POST", "https://api.wokelo.ai/api/enterprise/newsfeed/news/", bytes.NewBuffer(body))
